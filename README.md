...
1. 
**Clustering**: Run `clustering.py` to process the input array and view the generated cluster labels.


2. 
**Synonym Generation**: Run `word2vec.py` (requires Google News vectors) to generate the `similar_words.txt` dictionary.


3. 
**Classification**: Run `improved.py` to train the SVM on the semantically enhanced comments and view the final accuracy.
